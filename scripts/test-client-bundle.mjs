...
assert.deepEqual(Object.keys(bundle.manifest.artifacts).sort(), ["companyDirectory", "companySignals", "decisionHistory", "insightLedger", "landingDecision", "live", "marketHistory", "memoryDemand", "priceHistory", "quant", "quantBacktest", "siteContent", "siteContentExtended"]);
