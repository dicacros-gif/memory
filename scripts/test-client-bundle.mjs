...
assert.deepEqual(Object.keys(bundle.manifest.artifacts).sort(), ["companyDirectory", "decisionHistory", "insightLedger", "landingDecision", "live", "marketHistory", "priceHistory", "quant", "quantBacktest", "siteContent", "siteContentExtended"]);
