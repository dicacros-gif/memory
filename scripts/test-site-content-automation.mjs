...
assert.equal(artifact.organizationOperatingModel.capabilityProofs.length, 5);
assert.equal(artifact.organizationOperatingModel.cadence.length, 3);
...
assert.match(index, /infra-20260816-23/);
