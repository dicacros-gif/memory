...
assert.match(app, /Business Outcome → Workload\/SLO → Dominant Bottleneck → HW\/SW Options → Execution Gate/, "agent flow must follow the bottleneck-first consulting value chain");
