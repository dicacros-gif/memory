...
assert.doesNotMatch(html, /memory-hero-static|memory-hero-poster\.webp|id="memoryHeroVideo"|memory-hero-lite\.mp4/, "the removed console opening media must stay absent");
