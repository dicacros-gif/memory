...
assert.match(app, /const stockRenderLookAhead = Math\.max\(5200, Math\.round\(window\.innerHeight \* 5\)\)[\s\S]*?section\.id === "equity-value-chain"[\s\S]*?stockRenderObserver/, "the Stock dashboard should render ahead of the viewport during idle time");
...
assert.match(html, /app\.js\?v=site-audit-20260729-73/, "JavaScript cache key should include the site-audit revision");
...
assert.match(html, /styles\.css\?v=site-audit-20260729-73/, "CSS cache key should include the site-audit revision");
