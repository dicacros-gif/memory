...
assert.match(html, /styles\.css\?v=live-pipeline-kpi-countup-agent-reference-20260725-1/, "CSS cache key should include this integrated revision");
assert.match(html, /app\.js\?v=live-pipeline-kpi-countup-agent-reference-20260725-1/, "JavaScript cache key should include this integrated revision");
