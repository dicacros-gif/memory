...
assert.match(html, /styles\.css\?v=mm-hero-editorial-20260725-4/, "CSS cache key should include this integrated revision");
assert.match(html, /app\.js\?v=mm-hero-editorial-20260725-4/, "JavaScript cache key should include this integrated revision");
