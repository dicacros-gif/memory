...
assert.match(html, /app\.js\?v=site-audit-20260726-46/, "JavaScript cache key should include the site-audit revision");
...
assert.match(html, /styles\.css\?v=site-audit-20260726-46/, "CSS cache key should include the site-audit revision");
...
assert.match(app, /investment-focus-block is-gate[\s\S]*?investment-focus-block is-monitor/, "investment decision and monitoring blocks should expose distinct semantic styles");
assert.match(css, /\.investment-focus-block\.is-priority \{ --focus-card-accent: #0b8f62; \}[\s\S]*?\.investment-focus-block\.is-monitor \{ --focus-card-accent: #078579; \}/, "investment detail blocks should use a readable consulting palette");
