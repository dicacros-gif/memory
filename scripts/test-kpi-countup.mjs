...
assert.match(html, /app\.js\?v=figure-routing-20260730-01/, "JavaScript cache key should include the figure-routing revision");
...
assert.match(html, /styles\.css\?v=figure-routing-20260730-01/, "CSS cache key should include the figure-routing revision");
