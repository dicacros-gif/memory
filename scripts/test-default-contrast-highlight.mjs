...
assert.match(consoleCss, /transition:background \.06s linear,color \.06s linear,border-color \.06s linear,transform \.08s ease-out !important;[\s\S]*?transition-delay:0s !important;/, "stage-card color inversion must occur without perceptible delay");
