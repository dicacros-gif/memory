...
assert.match(consoleCss, /#strategyConsulting \.sc-consulting-report \{[\s\S]*?border-radius:\s*18px !important;[\s\S]*?background:\s*linear-gradient\(180deg,[\s\S]*?box-shadow:\s*0 14px 34px/, "account reports must use the rounded paper-and-rail consulting frame requested for this surface");
