...
assert.match(files.html.text, /assets\/css\/landing\.min\.css\?v=infra-20260817-41/);
assert.match(files.html.text, /assets\/js\/landing\.min\.js\?v=infra-20260817-41/);
