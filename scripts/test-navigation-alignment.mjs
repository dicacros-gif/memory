...
assert.match(landing, /node\.closest\("#intelligenceConsole \.sb-item, #intelligenceConsole \.sb-cat"\)[\s\S]*?classList\.remove\("ui-contrast-on-dark", "ui-contrast-on-light"\)/, "state-managed sidebar copy must clear stale automatic contrast tags");
