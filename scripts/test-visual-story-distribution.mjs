...
assert.match(css, /\.visual-insight-route > span \{[\s\S]*?clip-path:\s*none !important;/, "visual synthesis stage cards must use square corners without clipped cutouts");
