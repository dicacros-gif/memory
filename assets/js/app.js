    ...
    return [
      {
        ...
        implication: "SKHY는 HBM, 서버 DRAM, eSSD, 인터커넥트와 패키징을 고객 시스템 단위의 하나의 용량 로드맵으로 관리해야 합니다.",
        reversal: "AI CapEx 둔화, 토큰 증가율 하락, 소프트웨어 메모리 효율 개선",
      ...
      },
      {
        ...
        implication: "SKHY는 GPU 출하량뿐 아니라 CPU utilization, 추론 토큰, KV cache, 서버당 DRAM과 eSSD 탑재량을 고객 수요 지표로 묶어야 합니다.",
        reversal: "에이전트당 토큰 감소, CPU utilization 하락, 서버당 메모리 탑재량 정체",
        source: "Morgan Stanley",
        sourceRef: "Global Technology: Innovating the Next-Generation Memory",
        institution: "Morgan Stanley",
        evidenceType: "direct-report",
      ...
      },
      {
        ...
        implication: "SKHY는 프리미엄 물량을 장기계약으로 잠그되 가격 공식, 최소 구매와 재협상 조항을 고객별로 비교하고 범용 증설은 단계 집행해야 합니다.",
        reversal: "고객 재고 증가, 소비 수요 파괴, 경쟁사 bit growth 조기 회복",
        source: "Morgan Stanley",
        sourceRef: "Global Technology: Innovating the Next-Generation Memory",
        institution: "Morgan Stanley",
        evidenceType: "direct-report",
      ...
      },
      {
        ...
        implication: "SKHY는 고객 가격 공식에 수율, 패키징 처리량과 웨이퍼 생산성 저하를 함께 반영해 HBM4E의 실제 기여이익을 관리해야 합니다.",
        reversal: "수율 조기 안정, 고객 인증 지연, LTA 가격 재협상",
        source: "Morgan Stanley",
        sourceRef: "Global Technology: Innovating the Next-Generation Memory",
        institution: "Morgan Stanley",
        evidenceType: "direct-report",
      ...
      },
      {
        ...
        implication: "SKHY는 CXL 지연시간과 서버 수 절감 효과를 고객 PoC에서 동시에 측정하고, MRDIMM 인증과 묶어 시스템 비용 절감형 포트폴리오로 관리해야 합니다.",
        reversal: "지연 민감 workload 비중, 고객 PoC 경제성, 소프트웨어 상용화 지연",
        source: "Morgan Stanley",
        sourceRef: "Global Technology: Innovating the Next-Generation Memory",
        institution: "Morgan Stanley",
        evidenceType: "direct-report",
