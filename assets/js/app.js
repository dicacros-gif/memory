  ...
  const CHINA_DEEP_DIVE = [
    {
      ...
      facts: ["DDR5 수율 80%+는 Citigroup·SemiAnalysis 인용/모델 기반 Watch이며, 사이트 팩트 레이어에서는 Confirmed로 승격하지 않음", "CXMT 공식 공개는 DDR5-4800 제품 사양까지로 제한하고 16nm·17nm 공정 노드는 teardown/모델 추정치로 동등하게 분리", "HBM3는 2026년 1H 목표에서 2H 2026 이후로 지연됐고, 2027년 12-layer 물량화는 전망/Watch로 분리"],
    ...
    },
    {
      ...
      thesis: "MATCH Act는 아직 법률로 확정되지 않은 입법 Watch입니다. 하원 외교위 통과는 확인됐지만, 하원 본회의 통과 보도는 공식 tracker 확인 전까지 Watch로 분리합니다",
      facts: ["Cryogenic etch blanket ban removed, Reuters 2026-04-16", "DUV restriction retained", "HR 8170은 2026-04-22 하원 외교위 36:8 통과", "하원 본회의 통과 보도는 공식 tracker 확인 전 Watch, S.4281은 2026-04-13 Senate Banking Committee 회부"],
